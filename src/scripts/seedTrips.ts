...
images: [
  ...
  {
    title: 'Mefou National Park Primate Sanctuary',
    description: 'Experience a unique wildlife sanctuary just outside Yaoundé, where primates rescued from the illegal pet trade and bushmeat industry find refuge in a natural forest environment. Unlike traditional zoos, Mefou National Park provides large, open enclosures that closely mimic the animals\' natural habitats, allowing them to live in social groups as they would in the wild.',
