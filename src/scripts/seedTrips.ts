    ...
    detailed_itinerary: [
      {
        ...
        meals: ['Dinner'],
        accommodation: 'Kigali Serena Hotel or similar luxury hotel'
      },
      {
        day: 2,
